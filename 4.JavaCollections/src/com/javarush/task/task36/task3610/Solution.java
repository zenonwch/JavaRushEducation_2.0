...
public class Solution {
    public static void main(final String[] args) {
        final Map<Integer, Integer> map = new MyMultiMap<>(3);
        for (int i = 0; i < 7; i++) {
            map.put(i, i);
        }
        map.put(5, 56);
        ...
        System.out.println(map.remove(5));                                             //expected: 57
        System.out.println(map);                                                                        //expected: {0=0, 1=1, 2=2, 3=3, 4=4, 5=58, 6=6}
        System.out.println(map.remove(5));                                             //expected: 58
        System.out.println(map);                                                                        //expected: {0=0, 1=1, 2=2, 3=3, 4=4, 6=6}
        System.out.println(map.size());                                                              //expected: size = 6

        System.out.println(map.put(5, null));                                                      //null
